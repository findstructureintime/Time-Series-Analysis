...
data_matrix = generate_simulated_dataset(frequency_base, response_window, success_rate);

% Visualize the simulated data
vis_args.title = sprintf('Simulated_data_with_frequency_%d_response_window_%d_success_rate_%.1f', frequency_base, response_window, success_rate);
