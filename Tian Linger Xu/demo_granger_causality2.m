...
data_matrix = generate_simulated_dataset_var3(frequency_base, response_window, success_rate);

% Visualize the simulated data
vis_args.title = 'Simulated_data_with_one_leading_one_following_relations';
vis_args.annotation = {'variable1', 'variable2', 'variable3'};
...
[gcausal_mat, gcausal_fdr] = calculate_granger_causality(data_matrix(2:3, :, :));
